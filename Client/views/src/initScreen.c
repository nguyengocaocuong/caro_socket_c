...
void initHomeScreen(UserData *userData) {
    ...
    g_signal_connect(userData->gameApplication->homeContainer.window_home, "destroy", G_CALLBACK(gtk_main_quit_home), userData);
...
void initRegisterScreen(UserData *userData) {
    ...
    g_signal_connect(userData->gameApplication->registerContainer.btn_register, "clicked",
                     G_CALLBACK(on_register_rs_clicked), userData);
}
...
void initGameScreen(UserData *userData) {
    ...
    userData->gameApplication->gameContainer.lbl_status_game = (GtkWidget *) gtk_builder_get_object(builder,
                                                                                                    "lbl_status_game");
    userData->gameApplication->gameContainer.lbl_lost_total = (GtkWidget *) gtk_builder_get_object(builder,
                                                                                                   "lbl_lost_total");
    userData->gameApplication->gameContainer.lbl_win_total = (GtkWidget *) gtk_builder_get_object(builder,
                                                                                                  "lbl_win_total");
    ...
    css_set(provider_game, (GtkWidget *) userData->gameApplication->gameContainer.lbl_lost_total);
    css_set(provider_game, (GtkWidget *) userData->gameApplication->gameContainer.lbl_win_total);
